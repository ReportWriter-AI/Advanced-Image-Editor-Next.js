...
<body>
  ...
  <div style="margin-top: 1.25rem; margin-bottom: 2rem; background: #f8fafc; border: 1px solid #cbd5e1; border-radius: 0.5rem; padding: 1.5rem;">
    ...
    <div style="display: flex; flex-direction: column; gap: 1.75rem;">
      ...
      <!-- Post Inspection -->
      <div style="display: flex; flex-direction: column; gap: 0.5rem; page-break-inside: avoid;">
        <div style="font-weight: 700; color: #000000; font-size: 0.9375rem;">
      ...
      <div style="display: flex; flex-direction: column; gap: 0.5rem; page-break-inside: avoid;">
        ...
        <div style="font-size: 0.875rem; color: #374151; line-height: 1.6;">
          <p style="margin: 0 0 0.75rem 0; font-weight: 600;">Purpose:</p>
          ...
          <p style="margin: 0 0 0.75rem 0;">No responsibility is accepted if the Report is used for any other purpose.</p>
          
          <p style="margin: 0 0 0.75rem 0; font-weight: 600;">Scope:</p>
          <p style="margin: 0 0 0.75rem 0;">The Report is based on a limited visual, above-ground, non-invasive inspection of the standard systems and components of the building. AGI does not open up, uncover or dismantle any part of the building as part of the inspection or undertake any internal assessment of the building, aside from the electrical panel deadfront.</p>
          
          <p style="margin: 0 0 0.75rem 0; font-weight: 600;">Report Limitations &amp; Exclusions:</p>
          ...
          <p style="margin: 0 0 0.75rem 0; font-weight: 600;">The Report:</p>
          ...
          <p style="margin: 0 0 0.75rem 0; font-weight: 600;">Unit Title Properties:</p>
          ...
          <p style="margin: 0 0 0.75rem 0; font-weight: 600;">Responsibility to Third Parties:</p>
          ...
          <p style="margin: 0 0 0.75rem 0; font-weight: 600;">Publication:</p>
          ...
          <p style="margin: 0 0 0.75rem 0; font-weight: 600;">Claims &amp; Disputes:</p>
          ...
          <p style="margin: 0 0 0.75rem 0; font-weight: 600;">Limitation of Liability:</p>
          ...
          <p style="margin: 0 0 0.75rem 0; font-weight: 600;">Consumer Guarantees Act:</p>
          ...
          <p style="margin: 0 0 0.75rem 0; font-weight: 600;">Partial Invalidity:</p>
