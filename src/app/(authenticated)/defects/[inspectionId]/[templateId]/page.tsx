...
export default function DefectsPage() {
	...
	// State for selected section and subsection (initialized from URL params)
	const [selectedSectionId, setSelectedSectionId] = useState<string | undefined>(urlSectionId);
	const [selectedSubsectionId, setSelectedSubsectionId] = useState<string | undefined>(urlSubsectionId);
				...
				<CardContent className="pt-6">
					...
					{isLoading ? (
						...
						<div className="text-center py-12 bg-muted/30 rounded-lg border-2 border-dashed">
							...
							<p className="text-muted-foreground mb-6">Start documenting findings for this template.</p>
							<Button
								size="sm"
								className="gap-2 bg-[#6422C7] hover:bg-[#6422C7]/90"
								onClick={() => window.open(`/image-editor?templateId=${templateId}&inspectionId=${inspectionId}`, '_blank')}
