...
import { useDeletedTemplateSubsectionsQuery, useRestoreTemplateSubsectionMutation } from "@/components/api/queries/templateSubsections";
...
export function RestoreSubsectionModal({ open, onOpenChange, templateId, sectionId }: RestoreSubsectionModalProps) {
  const { data, isLoading, error, refetch } = useDeletedTemplateSubsectionsQuery(templateId, sectionId);
  const restoreMutation = useRestoreTemplateSubsectionMutation(templateId, sectionId);
