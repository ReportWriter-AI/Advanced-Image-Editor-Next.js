...
import { TemplateSection } from "@/components/api/queries/templateSections";
...
interface TemplateSectionFormProps {
  ...
  initialValues?: TemplateSection | null;
        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {initialValues
              ...
              : "Fill in the details to create a new section for this template."}
          </DialogDescription>
        </DialogHeader>
