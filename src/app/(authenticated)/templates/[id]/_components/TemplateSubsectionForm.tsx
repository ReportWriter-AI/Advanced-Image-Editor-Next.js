...
import { TemplateSubsection } from "@/components/api/queries/templateSubsections";
...
interface TemplateSubsectionFormProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSubmit: (values: SubsectionFormValues) => Promise<void>;
  initialValues?: TemplateSubsection | null;
  isSubmitting?: boolean;
}

export function TemplateSubsectionForm({
  open,
  onOpenChange,
  onSubmit,
  initialValues,
  isSubmitting = false,
}: TemplateSubsectionFormProps) {
