...
import { useDeletedInspectionTemplateSectionsQuery, useRestoreInspectionTemplateSectionMutation } from "@/components/api/queries/inspectionTemplateSections";
...
export function RestoreSectionModal({ open, onOpenChange, inspectionId, inspectionTemplateId }: RestoreSectionModalProps) {
  const { data, isLoading, error, refetch } = useDeletedInspectionTemplateSectionsQuery(inspectionId, inspectionTemplateId);
  const restoreMutation = useRestoreInspectionTemplateSectionMutation(inspectionId, inspectionTemplateId);
