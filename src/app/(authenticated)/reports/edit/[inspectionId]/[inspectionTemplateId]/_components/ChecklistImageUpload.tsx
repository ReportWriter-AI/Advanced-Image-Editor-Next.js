        ...
        {image.mediaType !== 'video' && (
          <button
            onClick={() => {
              ...
              const originalImageUrl = typeof image.url === 'string' ? image.url : previewUrl;
              const editorUrl = `/image-editor?imageUrl=${encodeURIComponent(imageUrl)}&originalImageUrl=${encodeURIComponent(originalImageUrl)}&returnTo=${encodeURIComponent(window.location.pathname)}&checklistId=${checklistId}&inspectionId=${inspectionId}`;
