...
export async function POST(request: NextRequest) {
  try {
    ...
    const newUser = await User.create({
      ...
      mobileNumber: role === 'inspector' ? (mobileNumber || undefined) : undefined,
      ...
      credentials: role === 'inspector' ? (credentials || undefined) : undefined,
      homeAddress: role === 'inspector' ? (homeAddress || undefined) : undefined,
      city: role === 'inspector' ? (city || undefined) : undefined,
      state: role === 'inspector' ? (state || undefined) : undefined,
      zipCode: role === 'inspector' ? (zipCode || undefined) : undefined,
      milesWantsToTravel: role === 'inspector' ? (milesWantsToTravel || undefined) : undefined,
      description: role === 'inspector' ? (description || undefined) : undefined,
      notes: role === 'inspector' ? (notes || undefined) : undefined,
