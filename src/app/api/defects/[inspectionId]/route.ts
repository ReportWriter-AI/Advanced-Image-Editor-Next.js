...
export async function PATCH(
  ...
  try {
    ...
    const updates = {
      ...
      defect_description,
      materials,
      material_total_cost: material_total_cost !== undefined ? Number(material_total_cost) : undefined,
      location,
      section,
      subsection,
      labor_type,
      labor_rate: labor_rate !== undefined ? Number(labor_rate) : undefined,
      hours_required: hours_required !== undefined ? Number(hours_required) : undefined,
      recommendation,
      isThreeSixty,
      additional_images,
      base_cost,
